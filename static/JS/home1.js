...
function getBotResponse(textInput) {
  ...
  // $("#formInput").scrollIntoView({ block: "start", behavior: "smooth" });
...
$("#micBtn").click(function (e) {
  ...
  recognition.onresult = function (event) {
    ...
    //   <div class="media-body">
    //     <h5 style="text-align:right" class="mt-0 mb-1">User</h5>
    //     <p class = "userText" style="text-align:right; margin-left: 400px;"><span>${event.results[0][0].transcript}</span></p>
    //   </div>
    //   <img src="static/SVG/mic-fill.svg" class="align-self-center ml-3" style="margin-right: 10px;" alt="User">
    // </div>`
